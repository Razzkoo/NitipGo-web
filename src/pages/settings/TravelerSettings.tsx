 ...
 import { Settings, Bell, Shield, Wallet, HelpCircle } from "lucide-react";
         ...
         <div className="grid gap-6 max-w-2xl">
           ...
           >
             ...
             <div className="space-y-4">
               ...
               <div className="flex items-center justify-between">
                 <div>
                   <p className="font-medium text-foreground">Pengingat Trip</p>
                   <p className="text-sm text-muted-foreground">Reminder sebelum trip dimulai</p>
                 </div>
                 <Switch defaultChecked />
               </div>
             </div>
