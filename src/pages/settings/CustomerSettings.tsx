 ...
 import { Settings, Bell, Shield, CreditCard, HelpCircle } from "lucide-react";
         ...
         <div className="grid gap-6 max-w-2xl">
           ...
           >
             ...
             <div className="space-y-4">
               ...
               <div className="flex items-center justify-between">
                 <div>
                   <p className="font-medium text-foreground">Promo & Penawaran</p>
                   <p className="text-sm text-muted-foreground">Update promo terbaru</p>
                 </div>
                 <Switch />
               </div>
             </div>
           ...
           >
             ...
             <div className="space-y-3">
               ...
               <Button variant="outline" className="w-full justify-start" asChild>
                 <Link to="/live-chat">Hubungi Support</Link>
               </Button>
             </div>
           </motion.div>
