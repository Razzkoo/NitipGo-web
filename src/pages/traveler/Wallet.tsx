...
import { ArrowLeft, Wallet, CreditCard, Building2, CheckCircle, AlertCircle } from "lucide-react";
        ...
        <div className="container">
          ...
          <div className="max-w-xl mx-auto space-y-6">
            ...
            >
              ...
              <p className="text-4xl font-bold">Rp {balance.toLocaleString()}</p>
              <p className="text-accent-foreground/70 mt-2">Tersedia untuk ditarik</p>
            </motion.div>
                  ...
                  <div className="space-y-3">
                    ...
                    {withdrawMethods.map((method) => (
                      ...
                      >
                        ...
                        <div className={`h-5 w-5 rounded-full border-2 ${selectedMethod === method.id ? "border-primary bg-primary" : "border-muted"}`}>
                          {selectedMethod === method.id && (
