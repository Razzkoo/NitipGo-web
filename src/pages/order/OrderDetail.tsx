...
import { ArrowLeft, Package, MapPin, User, Star, MessageSquare, CheckCircle, Clock, ArrowRight, Phone } from "lucide-react";
...
export default function OrderDetail() {
  ...
  const order = mockOrders[id || ""] || mockOrders["ORD-001"];
            ...
            <div className="space-y-6">
              ...
              {order.status === "in_progress" && !showRating && (
                <motion.div
                  ...
                  className="rounded-2xl bg-gradient-primary p-6"
                >
                  <p className="text-primary-foreground/80 mb-4">
                    Sudah menerima barang? Konfirmasi untuk menyelesaikan order.
                  </p>
                  <Button variant="white" className="w-full" onClick={handleConfirmReceived}>
