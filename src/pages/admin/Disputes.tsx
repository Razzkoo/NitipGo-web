...
import { ArrowLeft, AlertTriangle, MessageSquare, CheckCircle, Eye, Clock } from "lucide-react";
          ...
          <div className="rounded-xl bg-card p-4 shadow-card">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-foreground">{disputes.filter(d => d.status === "open").length}</p>
              </div>
            </div>
          </div>
          <div className="rounded-xl bg-card p-4 shadow-card">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-foreground">{disputes.filter(d => d.status === "in_review").length}</p>
              </div>
            </div>
          </div>
          <div className="rounded-xl bg-card p-4 shadow-card">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-foreground">{disputes.filter(d => d.status === "resolved").length}</p>
              </div>
            </div>
          </div>
        </div>
