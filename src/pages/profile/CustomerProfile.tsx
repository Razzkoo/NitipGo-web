...
import {
  ...
  ShoppingBag, Star, Clock, Trash2, Lock,
} from "lucide-react";
...
export default function CustomerProfile() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const mapped: CustomerProfileType = {
          id:            user.id,
          name:          user.name,
          email:         user.email,
          phone:         user.phone ?? "",
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      toast({
        title: error.response?.data?.message ?? "Gagal menghapus akun",
        variant: "destructive",
      });
    } finally {
      setIsDeleting(false);
  ...
  const statsConfig = [
    ...
    },
    {
      ...
      value: profile?.stats?.rating_given ?? 0,
      icon: Star,
    },
    {
      label: "Bulan Aktif",
      value: profile?.stats?.months_active ?? 0,
      icon: Clock,
    },
  ];
      ...
      <div className="p-6 md:p-8 lg:p-10">
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold md:text-3xl">Profil Saya</h1>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <b>Hapus Akun</b> untuk konfirmasi.
            </DialogDescription>
          </DialogHeader>
